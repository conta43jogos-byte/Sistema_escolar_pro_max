...
export default function Sidebar({ user, collapsed, onToggle, mobileOpen, onMobileClose }) {
  ...
  return (
    <>
      ...
      <aside className={`fixed left-0 top-0 h-screen bg-sidebar text-sidebar-foreground flex flex-col z-50 transition-all duration-300
      ...
      `}>
        ...
        <button
          onClick={onMobileClose}
          className="lg:hidden absolute top-4 right-4 w-8 h-8 rounded-lg bg-sidebar-accent/50 flex items-center justify-center text-sidebar-foreground/70 hover:text-sidebar-foreground transition-colors"
        >
          <X className="w-4 h-4" />
        </button>
